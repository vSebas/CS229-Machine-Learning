\begin{answer}
    \begin{enumerate}[label=\roman*.]
        ...
        \item 
        The semi-supervised EM was more stable: cluster assignments remained consistent across random initializations (Fig. \ref{fig:semi_pred0}, \ref{fig:semi_pred1}, \ref{fig:semi_pred2}),
        while the unsupervised EM swapped labels or converged to different local optima (Fig. \ref{fig:unsup_pred_s0}, \ref{fig:unsup_pred_s1}, \ref{fig:unsup_pred_s2}).
