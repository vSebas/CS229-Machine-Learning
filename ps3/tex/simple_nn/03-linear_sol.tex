...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{figs/linear_weights.pdf}
...
$o(x)=\mathbbm{1}\{b+v^\top x>0\}$. A single line cannot realize the triangular decision set,
 so perfect classification is impossible; we obtain $\approx0.701$ in the example. Fig. 10 shows the plot with the prediction.
